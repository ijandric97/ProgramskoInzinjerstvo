...
public class GUI implements ActionListener {
	...
	private void initialize() {
		...
		btnPotrazi = new JButton("Potraži");
		btnPotrazi.setBounds(231, 27, 117, 25);
		desktopPane.add(btnPotrazi);
		
		btnPotrazi.addActionListener(this);
